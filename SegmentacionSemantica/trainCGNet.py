...
)  # Cambiar a false, barch = 8

filepath = "best_pesos_CGNet.h5"
...
modelo.save("modelCGNet.h5")
modelo.save_weights("pesosCGNet.h5")
# convert the history.history dict to a pandas DataFrame:
hist_df = pd.DataFrame(history.history)

# save to json:
hist_json_file = "historyCGNet.json"
with open(hist_json_file, mode="w") as f:
    hist_df.to_json(f)

# or save to csv:
hist_csv_file = "historyCGNet.csv"
